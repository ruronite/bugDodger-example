...
function create () {
	...
	//added a highscore bar
	gameState.highScoreText = this.add.text(120, 340, `highScore: ${gameState.highScore}`);
	...
	const bugGen = () => {
		...
		bugs.create(xCoord, -20, randomBug)
	}
